# Generated by Django 5.1.7 on 2025-04-07 02:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('monthly_rent', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('beds', models.DecimalField(decimal_places=0, default=1, max_digits=8)),
                ('baths', models.DecimalField(decimal_places=0, default=1, max_digits=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='rentals.unit')),
            ],
        ),
        migrations.AddField(
            model_name='lease',
